# /packages/intranet-reporting-cubes/www/finance-cube-cust-champ.tcl
#
...
lappend derefs "sub_project_name as subp_project_name"
lappend derefs "sub_project_nr as subp_project_nr"

# Project Paths
set project_path_full_sql "
	CASE (select im_project_sub_project_name_path(c.sub_project_id,false,false)) 
	WHEN '' THEN '-- Not found --' 
	ELSE (select im_project_sub_project_name_path(c.sub_project_id,false,false)) END as project_path_full
"
set project_path_shortend_sql "
        CASE (select im_project_sub_project_name_path(c.sub_project_id,true,true)) 
	WHEN '' THEN '-- Not found --' 
	ELSE (select im_project_sub_project_name_path(c.sub_project_id,true,true)) END as project_path_shortend
"
